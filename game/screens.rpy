...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(15, 267, 1098, 195) action Start()
        hotspot(15, 465, 622, 145) action ShowMenu("load")
        hotspot(23, 621, 443, 128) action ShowMenu("preferences")
        hotspot(20, 747, 314, 115) action ShowMenu("about")
        hotspot(19, 861, 290, 122) action Quit(confirm=True)
        hotspot(1681, 984, 218, 86) action ShowMenu("help")
