...
define config.name = _("Русская Депрессия")
...
define config.version = "prealpha"
...
define gui.about = _p("""
На эту "игру" было потрачено неприлично много времени и сил.

Будьте благодарны, что вы играете в такой шедевр.

Автор почти всего что есть в этой игре - domitori.

Музыка что использовалась здесь:
...
define build.name = "RussianDepression"
...
define config.save_directory = "RussianoDepressiano-1654960736"
